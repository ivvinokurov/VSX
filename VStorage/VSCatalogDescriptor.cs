...
namespace VStorage
{
    public class VSCatalogDescriptor
    {
        public VSCatalog CATALOG = null;
        ...
        {
            ulong chs = (ulong)((Id * 123456789) - space_size_pg * 3 + extension_pg * 5 - page_size_kb * 7 + partitions * 9 - VSLib.ConvertStringToByte(CATALOG.ste)[0]);
